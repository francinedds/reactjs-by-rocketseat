  ...
  return (
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="end" className="w-56">
        ...
        <DropdownMenuItem className='flex flex-row mt-2'>
            <Building className="mr-2 w-4 h-6" />
            <span>Perfil da Loja</span>
        </DropdownMenuItem>
        </DialogTrigger>

        <DropdownMenuItem asChild className="flex flex-row mt-2 items-center text-rose-500 dark:text-rose-400" disabled={isSigningOut}>
